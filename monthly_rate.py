...
parser.add_argument("-p",   "--principal", type=float, default=100000, help="Principal Loan")
parser.add_argument("-i",   "--interest", type=float, required=True, help="Annual interest rate")
parser.add_argument("-n",   "--number_of_months", type=int, default=360, help="Count of payments")
